...
Привет, друг. мы ждали тебя.

Поможем тебе увидеть прибыль по всему своему кошельку или выбранной монете, без изучения сложных инструментов.

Подключи кошелек через приложение, чтобы начать:
`, {
      reply_markup: {
        inline_keyboard: [[
          {
...
//   bot.on('inline_query', async ctx => {})
  ...
  bot.on(message('web_app_data'), async ctx => {
    ...
    await ctx.reply(`
🎉 Теперь ты можешь сразу увидеть прибыль по всему своему кошельку или выбранной монете.

И с легкостью вывести свою прибыль вовремя. 
